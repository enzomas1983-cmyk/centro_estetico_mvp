...
import 'package:centro_estetico_mvp/providers/auth_provider.dart';
      ...
      pw.Page(
        build: (_) => pw.Center(
          child: pw.Column(
            mainAxisAlignment: pw.MainAxisAlignment.center,
            children: [
              pw.Text("Prenota online", style: const pw.TextStyle(fontSize: 24)),
              pw.SizedBox(height: 20),
              pw.Image(pw.MemoryImage(image.buffer.asUint8List())),
              pw.SizedBox(height: 20),
              pw.Text(link),
      ...
      body: FutureBuilder<String>(
        ...
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data == null) {
            return const Center(child: Text("Errore caricamento slug"));
          }

          final slug = snapshot.data!;

          /*final publicUrl =
              "https://tuodominio.it/shop/$slug";*/

          final String publicUrl =
              "https://lucent-chebakia-a9d7d0.netlify.app/book/$businessId";
